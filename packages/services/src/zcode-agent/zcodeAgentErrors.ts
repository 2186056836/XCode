...
export class XCodeAgentMcpStatusModeUnsupportedError extends Error {
  ...
  constructor() {
    ...
    this.name = "XCodeAgentMcpStatusModeUnsupportedError";
  }
}

export function isXCodeAgentMcpStatusModeUnsupportedError(error: unknown): boolean {
