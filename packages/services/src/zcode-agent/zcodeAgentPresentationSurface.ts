...
export type XCodeAgentPresentationSurface = "desktop";

interface XCodeAgentPresentationHostFacts {
...
export function resolveXCodeAgentPresentationSurface(
  facts: XCodeAgentPresentationHostFacts,
): XCodeAgentPresentationSurface | undefined {
