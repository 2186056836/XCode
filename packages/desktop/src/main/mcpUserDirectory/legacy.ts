...
function buildLegacyCommonMcpStorageCandidates(request?: MigrateLegacyCommonMcpRequest): string[] {
  ...
  candidates.push(
    ...
    join(appData, "XCode", "Local Storage", "leveldb"),
    join(appData, "XCode", "Partitions", "zcode-embedded-browser", "Local Storage", "leveldb"),
    join(appData, "XCode Dev", "Local Storage", "leveldb"),
    join(appData, "XCode Dev", "Partitions", "zcode-embedded-browser", "Local Storage", "leveldb"),
  );
