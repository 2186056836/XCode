...
function mapMcpTelemetryEvent(event: Exclude<XCodeMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<XCodeMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
