...
import type { XCodeArchivedTaskDeletionResult } from "@zcode/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: XCodeTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | XCodeArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: XCodeTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
