import type { XCodeTaskGroupColor } from "@zcode/services";
...
const TASK_GROUP_COLOR_CLASS: Record<XCodeTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<XCodeTaskGroupColor, string> = {
