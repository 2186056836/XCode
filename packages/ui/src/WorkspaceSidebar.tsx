...
import type { Locale, RemoteTarget, UserInfo, XCodeTaskMeta } from "@zcode/shared";
...
const EMPTY_WORKSPACE_TASK_ITEMS: XCodeTaskMeta[] = [];
...
export const WorkspaceSidebar = memo(function WorkspaceSidebarComponent({
  ...
  const bumpTaskListVersion = useXCodeSessionStore((state) => state.bumpTaskListVersion);
