import type { XCodeModelTrajectoryMessage } from "@zcode/services";
...
type IntlShape = ReturnType<typeof useXCodeIntl>["intl"];
...
function compactTextPreview(message: XCodeModelTrajectoryMessage): string {
...
function firstLinePreview(message: XCodeModelTrajectoryMessage): string {
...
function messageClipboardText(message: XCodeModelTrajectoryMessage): string {
