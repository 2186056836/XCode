...
import { XCodeIntlProvider, useXCodeIntl } from "@/i18n/IntlProvider.js";
...
function resolveImportedArtifactPath(
  ...
  // 取舍：这里只校验形状（.xcode-share/<dir>/shared-artifacts/<file> 四段），刻意不把
  ...
  // .xcode-share/*/shared-artifacts/ 内，无越权读放大。
...
export function ConversationShareReadonlyTimeline({
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <XCodeIntlProvider initialLocale={locale}>
