...
import { isXCodeAgentProvider, ZCODE_AGENT_PROVIDER, type XCodeProvider } from "@zcode/shared";
...
export function useDraftModelReadinessGate(params: {
  ...
  const enabled = sessionId === null && isXCodeAgentProvider(displayProvider);
