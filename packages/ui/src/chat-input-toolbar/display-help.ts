...
export const ZCODE_MODE_OPTION_LABEL_IDS: Record<XCodeProvider, Record<string, string>> = {
  glm: {
...
export const ZCODE_MODE_OPTION_DESCRIPTION_IDS: Record<XCodeProvider, Record<string, string>> = {
  glm: {
