...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like XCode to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let XCode remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting XCode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen XCode.",
  ...
  "startup.global.starting_services": "Starting XCode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "XCode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another XCode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen XCode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen XCode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen XCode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a XCode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into XCode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to XCode and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to XCode",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to XCode",
  "login.description": "Connect your account to start using XCode",
  ...
  "logout.confirm.title": "Disconnect and restart XCode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only XCode Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About XCode",
  ...
  "titleBar.menu.help.toggleXCodeStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update XCode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart XCode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the XCode CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "XCode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.customSystemMessages.title": "Agent prompt",
  "settings.customSystemMessages.description": "Changes the XCode identity setting.",
  "settings.customSystemMessages.edit": "Edit",
  "settings.customSystemMessages.restoreDefault": "Restore default",
  "settings.customSystemMessages.saveError": "Failed to save the agent prompt",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the XCode terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While XCode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .xcode/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the XCode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching XCode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by XCode",
  ...
  "resourceManager.storage.diskUsage": "XCode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the XCode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "XCode could not verify its Windows secure import component. Reinstall or update XCode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, XCode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by XCode Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "XCode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This XCode Agent cannot refresh OAuth status. Upgrade or restart XCode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to XCode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into XCode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to XCode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by XCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in XCode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. XCode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.importModels.button": "Fetch from upstream",
  "settings.modelProvider.importModels.sharedConfig": "Shared model config (applies to all selected)",
  "settings.modelProvider.importModels.invalid.contextWindow": "Context window must be a positive integer",
  "settings.modelProvider.importModels.invalid.maxOutputTokens": "Max output tokens must be a positive integer",
  "settings.modelProvider.importModels.invalid.reasoningLevelValues":
    "Reasoning levels must be non-empty and unique; text input must stay enabled",
  "settings.modelProvider.importModels.title": "Import models from upstream",
  "settings.modelProvider.importModels.description":
    "Fetches the model list from the provider's Base URL (GET /models). Select the models to add; imported models use recommended configuration.",
  "settings.modelProvider.importModels.loading": "Fetching model list…",
  "settings.modelProvider.importModels.retry": "Retry",
  "settings.modelProvider.importModels.empty": "The upstream returned no models.",
  "settings.modelProvider.importModels.searchPlaceholder": "Filter models…",
  "settings.modelProvider.importModels.selectAll": "Select all",
  "settings.modelProvider.importModels.alreadyAdded": "Added",
  "settings.modelProvider.importModels.cancel": "Cancel",
  "settings.modelProvider.importModels.import": "Add {count} selected models",
  "settings.modelProvider.importModels.importing": "Importing…",
  "settings.modelProvider.importModels.result": "Import finished: {added} added, {failed} failed.",
  "settings.modelProvider.importModels.close": "Close",
  "settings.modelProvider.importModels.error.providerUnavailable":
    "This provider is currently unavailable. Enable it and try again.",
  "settings.modelProvider.importModels.error.endpointUnavailable":
    "Configure a valid Base URL for this provider before fetching models.",
  "settings.modelProvider.importModels.error.auth":
    "Authentication failed (401/403). Check the API key for this provider.",
  "settings.modelProvider.importModels.error.network":
    "Network error. Check the Base URL, proxy settings and try again.",
  "settings.modelProvider.importModels.error.timeout": "The request timed out. Try again later.",
  "settings.modelProvider.importModels.error.server": "The upstream server returned an error",
  "settings.modelProvider.importModels.error.invalidResponse":
    "Unrecognized response format. Expected an OpenAI-compatible /models response ({ data: [{ id }] }).",
  "settings.modelProvider.importModels.error.unknown": "Failed to fetch the upstream model list.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in XCode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "XCode MCP",
  ...
  "sidebar.usage.plan.mcp": "XCode MCP",
  "sidebar.usage.plan.zcodeMcp": "XCode MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for XCode built-in plugin MCPs",
  ...
  "settings.modelProvider.freeTitle": "Free providers",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into XCode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. XCode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into XCode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by XCode Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend XCode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into XCode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. XCode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into XCode",
  ...
  "settings.commands.description":
    "Manage XCode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "XCode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into XCode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. XCode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into XCode",
  ...
  "settingsSync.action.finish": "Start using XCode",
  "settingsSync.agent.zcode": "XCode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current XCode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to XCode",
  ...
  "onboarding.welcome.title": "Welcome to XCode",
  "onboarding.welcome.start": "Start XCode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while XCode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "XCode will copy {source} to {target}.\nIf the target file already exists, the XCode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask XCode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask XCode anything…",
  ...
  "chat.message.editAssistant": "Edit",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, XCode will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want XCode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart XCode app and retry, or ask XCode to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with XCode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for XCode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with XCode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current XCode Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'XCode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No XCode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "XCode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "XCode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while XCode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task XCode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "XCode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "XCode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart XCode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart XCode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified XCode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "XCode will verify the Computer Use tools against the exact session when your first session starts.",
