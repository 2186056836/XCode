...
import type { WorkspaceFileEntry, XCodeTaskChangeSummary, XCodeTaskMeta } from "@zcode/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = XCodeTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = XCodeTaskChangeSummary["files"][number];
...
function getTaskTitle(task: XCodeTaskMeta, untitledLabel: string): string {
