import type { McpServerConfig, XCodeMcpServer } from "@zcode/shared";
...
export function serverToForm(server: XCodeMcpServer): FormState {
...
// 与 shared 层 convertToXCodeAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
