...
import { DEFAULT_PERSONAL_PROVIDER_API_FORMAT } from "./constants.js";
...
export function resolvePendingProviderDraftSave({
  ...
  const typeChanged =
    !readOnlyEndpoints && draft.apiFormat !== (provider.config.api?.type ?? DEFAULT_PERSONAL_PROVIDER_API_FORMAT);
