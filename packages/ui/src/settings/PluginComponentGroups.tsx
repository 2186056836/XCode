import type { XCodePluginComponentKind } from "@zcode/shared";
...
const COMPONENT_BADGE_STYLES: Record<XCodePluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<XCodePluginComponentKind, string> = {
