...
import type { McpSource, XCodeMcpServer } from "@zcode/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: XCodeMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: XCodeMcpServer) => void;
}) {
  const { intl } = useXCodeIntl();
