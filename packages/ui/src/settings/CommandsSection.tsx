...
import type { CommandConfig, UserCommand, XCodeCommand } from "@zcode/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: XCodeCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: XCodeCommand[]) => (
    <SettingsResourceList
      items={items}
