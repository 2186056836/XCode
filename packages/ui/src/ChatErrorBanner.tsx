 ...
 *
 * 显示 XCode Agent 链路中的错误，带 traceId 方便排查。
 */
...
function isModelConfigMissingError(error: Pick<XCodeUiError, "code" | "message">): boolean {
...
export function shouldSuppressChatErrorBanner(
  error: Pick<XCodeUiError, "code" | "message">,
): boolean {
