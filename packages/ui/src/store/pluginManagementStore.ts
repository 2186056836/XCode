...
export interface PluginManagementState {
  ...
  diagnostics: XCodePluginDiagnostic[];
  loading: boolean;
  error: string | null;
  /**
...
function throwForErrorDiagnostic(diagnostics: XCodePluginDiagnostic[]): void {
