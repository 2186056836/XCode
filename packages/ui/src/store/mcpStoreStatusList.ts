import type { McpServerStatus, XCodeMcpServer, XCodeMcpServerStatusSnapshot } from "@zcode/shared";
...
function mapRuntimeStatusToUi(snapshot: XCodeMcpServerStatusSnapshot): MappedMcpServerStatus {
