...
import { isXCodeCuaToolName } from "@/lib/cuaPermissionAction.js";
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isXCodeCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useXCodeIntl>["intl"];
