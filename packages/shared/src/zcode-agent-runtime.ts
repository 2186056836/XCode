export type XCodeAgentBinaryKind = "native-binary";

export interface XCodeAgentRuntimeDescriptor {
  binaryKind: XCodeAgentBinaryKind;
  binaryEnvVar: string;
...
export function getXCodeAgentRuntime(): XCodeAgentRuntimeDescriptor {
