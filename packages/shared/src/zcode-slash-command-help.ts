export type BuiltinXCodeSlashCommandHelpEntry = {
...
export const BUILTIN_ZCODE_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinXCodeSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.xcode/AGENTS.md.",
      ],
      name: "init",
