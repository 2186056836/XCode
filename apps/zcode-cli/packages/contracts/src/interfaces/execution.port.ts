...
export type ExecutionCommand =
  ...
  | {
      ...
      /**
       * XCode runtime-provided Bash shell selection. Current consumers must only use
...
export interface ExecutionShellSelection {
  ...
  label?: string;
  /** Executable path when XCode resolved a concrete shell. Omitted for legacy shell fallback. */
  path?: string;
