...
import { getXCodeAgentModeSelectOptions, normalizeAvailableXCodeMode } from "@zcode/shared";
import type { XCodeSessionSettingsState, XCodeSlashCommand } from "@zcode/shared";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpXCodeAgent 的注释）。
