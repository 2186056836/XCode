import { parseRemoteWorkspaceIdentity, type XCodeWorkspaceRef } from "@zcode/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): XCodeWorkspaceRef {
