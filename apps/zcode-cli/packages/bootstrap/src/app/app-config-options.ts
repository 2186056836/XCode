...
export function createConfigCliOverrides(options: XCodeAppOptions): RuntimeConfigPatch | undefined {
...
function detectAppLocale(options: XCodeAppOptions): SupportedLocale | undefined {
