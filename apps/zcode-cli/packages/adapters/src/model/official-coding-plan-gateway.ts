import { resolveRuntimeXCodeEndpointOrigin } from "@zcode/shared";
import type { EnvRecord } from "./model-execution.js";

/**
 * 官方 Coding Plan 的模型请求经 XCode 平台网关发送。
 *
 * Z.ai / BigModel Coding Plan 是 XCode 的官方订阅套餐，模型请求统一发往 XCode 平台网关，
...
export function resolveOfficialCodingPlanGatewayUrl(
  ...
  const gatewayUrl = new URL(gatewayPath, resolveRuntimeXCodeEndpointOrigin(env));
