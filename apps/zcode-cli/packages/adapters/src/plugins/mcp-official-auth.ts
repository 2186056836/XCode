 ...
 */
import type { McpOfficialProvenance, XCodeOfficialMcpAuthConfig } from "@zcode/contracts";
 ...
 */
export function parseXCodeOfficialAuth(
  value: unknown,
  mcpKey: string,
): XCodeOfficialMcpAuthConfig | undefined {
